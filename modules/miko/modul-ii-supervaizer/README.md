...
| Действие                           | Назначение                                                          |
| ---------------------------------- | ------------------------------------------------------------------- |
| **Запустить анализ новых звонков** | Найти импортированные расшифровки без результата и создать задания. |
...
| ------------------------ | ----------- | ------------------------------------------------------------------------------- |
| **Qwen3 8B Instruct Q4** | `qwen3:8b`  | Рекомендуемый повседневный вариант для русских звонков, сводок и строгого JSON. |
