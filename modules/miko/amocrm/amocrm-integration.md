...
* Адреса должен быть доступен по **https** протоколу, необходимо получить валидный SSL сертификат (см. как пример [lets encrypt модуль](../module-get-ssl-lets-encrypt.md))
