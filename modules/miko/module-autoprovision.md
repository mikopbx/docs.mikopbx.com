---
description: >-
  Автоматическая настройка IP-телефонов в MikoPBX. Модуль обнаруживает
  телефоны в локальной сети, отдаёт им готовую SIP-конфигурацию и может
  централизованно раздавать прошивки.
---
