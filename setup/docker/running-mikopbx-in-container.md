...
Do not forget to configure the external firewall correctly for your PBX. You can find the setup instructions [here](../../security/external-firewall-enforcement.md).
