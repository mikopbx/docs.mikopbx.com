...
{% hint style="info" %}
Для простой реализации рекомендуется использовать модуль "[Управление телефонными группами](../../modules/miko/manage-call-groups.md)". Способ из данной статьи предназначен для более тонкой настройки.
{% endhint %}
