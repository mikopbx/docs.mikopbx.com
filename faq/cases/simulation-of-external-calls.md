...
4. В меню создания провайдера, перейдите в "**Расширенные настройки**", в поле "**Дополнительные параметры**" вставьте следующие правки:
...
<figure><img src="../../.gitbook/assets/ADDparametersOfProviderForImmitation.png" alt=""><figcaption><p>Поле "Дополнительные параметры"</p></figcaption></figure>
