...
# Подключение S3 хранилища AWS (IN DEV)
...
2. Перейдите на вкладку "**Облачное хранилище S3**" и заполните следующие поля:
   ...
   * **URL точки доступа S3** — введите адрес доступа к S3 AWS, в зависимости от региона Вашего бакета (таблица со всеми&#x20;
...
<mark style="color:$danger;">IN DEV!</mark>
