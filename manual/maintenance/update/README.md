...
{% hint style="danger" %}
Before updating, be sure to back up your PBX settings using the [**backup module**](https://github.com/mikopbx/docs.mikopbx.com/blob/english/manual/maintenance/backup.md).
{% endhint %}
