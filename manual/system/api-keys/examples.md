...
Настоятельно рекомендуется выпустить доверенный сертификат. Самый простой способ сделать это — с помощью [модуля Let's Encrypt](../../../modules/miko/module-get-ssl-lets-encrypt.md).
{% endhint %}
