...
Статические маршруты больше не нужно добавлять через **Кастомизацию системных файлов** и файл **/etc/static-routes**. Актуальная настройка выполняется в web-интерфейсе MikoPBX в разделе сетевых интерфейсов.
...
### Как сохранить и применить настройки

После заполнения маршрутов нажмите **Сохранить** внизу страницы **Сетевые интерфейсы**.

<figure><img src="../../.gitbook/assets/network-static-routes-save.png" alt=""><figcaption><p>Сохранение сетевых настроек</p></figcaption></figure>

MikoPBX сохраняет маршруты вместе с настройками сети и применяет их автоматически. Редактировать **/etc/static-routes** вручную больше не требуется.
...
### Как изменить или удалить маршрут

Чтобы изменить маршрут, откройте **Сеть и Firewall** → **Сетевые интерфейсы**, найдите блок **Статические маршруты**, исправьте нужную строку и нажмите **Сохранить**.

Чтобы удалить маршрут, нажмите кнопку удаления в строке маршрута и затем нажмите **Сохранить**. Если нужно создать похожее правило, используйте кнопку **Скопировать маршрут**, измените отличающиеся поля и сохраните настройки.

<figure><img src="../../.gitbook/assets/network-static-routes-edit-delete.png" alt=""><figcaption><p>Изменение и удаление статического маршрута</p></figcaption></figure>
