---
description: >-
  Модуль GeoIP блокирует входящие соединения к MikoPBX из выбранных стран на
  уровне файрвола. Защищает АТС от SIP-сканеров, подбора паролей и нежелательных
  звонков. Работает для IPv4 и IPv6.
---
