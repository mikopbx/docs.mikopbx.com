...
description: >-
  ...
  файла в стандартный редактор «Звуковых файлов» одной к
---
...
* **Частота дискретизации** — _Исходная (22 кГц)_ для студийной предпрослушки и HD-кодеков (g.722, opus); _Телефонная (8 кГц моно)_ для классических g.711 транков.
