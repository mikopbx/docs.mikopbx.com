...
Скачиваем и импортируем стандартный шаблон мониторинга Asterisk - [ссылка](https://git.zabbix.com/projects/ZBX/repos/zabbix/browse/templates/tel/asterisk_http?at=release/6.4).

Дополнительно скачиваем и импортируем шаблон MikoPBX - [ссылка](https://github.com/mikopbx/ModuleZabbixAgent5/blob/develop/bin/zbx_export_templates.yaml).
