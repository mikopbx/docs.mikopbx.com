...
<figure><img src="../.gitbook/assets/finalConsoleMikoPBX (1).png" alt=""><figcaption><p>Пример консоли MikoPBX</p></figcaption></figure>

В данном примере - IP-адрес **172.25.233.36**. Для перехода в web-интерфейс введите этот IP в адресную строку вашего браузера:

<figure><img src="../.gitbook/assets/firstLoginToMikoPBXWEB (1).png" alt=""><figcaption><p>Окно входа в MikoPBX</p></figcaption></figure>
