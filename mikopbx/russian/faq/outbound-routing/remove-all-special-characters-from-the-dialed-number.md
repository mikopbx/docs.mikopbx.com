...
<figure><img src="../../.gitbook/assets/1 (4).png" alt=""><figcaption><p>Окно "Кастомизация системных файлов"</p></figcaption></figure>

2. Править будем файл **extensions.conf**.

<figure><img src="../../.gitbook/assets/2 (4).png" alt=""><figcaption><p>Файл 'Extensions.conf"</p></figcaption></figure>
