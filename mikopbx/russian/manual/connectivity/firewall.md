...
<figure><img src="../../.gitbook/assets/new1 (1).png" alt=""><figcaption><p>Раздел "<strong>Сеть и Firewall</strong>" -> "<strong>Сетевой экран</strong>" в MikoPBX</p></figcaption></figure>

Для того, чтобы добавить новое правило, необходимо нажать на кнопку "**Добавить новую подсеть**":

<figure><img src="../../.gitbook/assets/new2 (1).png" alt=""><figcaption><p>Элемент для создания нового правила</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/13 (5).png" alt=""><figcaption><p>Параметры правила</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/14 (1).png" alt=""><figcaption><p>Раздел "<strong>Доступные сервисы</strong>"</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/15 (4).png" alt=""><figcaption><p>Раздел "<strong>Дополнительные параметры</strong>"</p></figcaption></figure>
...
* Внешний bouncer (CrowdSec-совместимый) поверх API MikoPBX — подробнее в разделе [Внешний файрвол для Docker](../../security/external-firewall-enforcement.md).
