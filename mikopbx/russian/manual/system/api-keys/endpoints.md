...
* [Эндпоинт firewall-export](firewall-export.md) — экспорт решений о блокировке для внешних bouncer'ов (CrowdSec-совместимый формат). Доступен с **MikoPBX 2026.1.76**.
