...
7. On the next tab, specify the number of CPU cores to be used. For a small company, 1–2 cores is sufficient (see [this article](../../../readme/system-requirements.md) for more details).
