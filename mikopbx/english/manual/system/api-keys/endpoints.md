...
* [The firewall-export endpoint](firewall-export.md) — exports ban decisions for external bouncers (CrowdSec-compatible). Available starting from **MikoPBX 2026.1.76**.
