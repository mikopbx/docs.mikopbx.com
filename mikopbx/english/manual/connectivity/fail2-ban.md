...
<figure><img src="../../.gitbook/assets/new1 (2).png" alt=""><figcaption><p>"Firewall and anti-hacking protection are enabled" switch</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/4 (17).png" alt=""><figcaption><p>Blocked addresses list</p></figcaption></figure>
...
{% hint style="info" %}
**In Docker (bridge mode)** fail2ban writes bans to Redis but the container cannot manage host iptables — web-interface bans are not applied automatically. To project them to the host, run an external bouncer (see [External firewall for Docker](../../security/external-firewall-enforcement.md)). SIP protection works normally.
{% endhint %}
