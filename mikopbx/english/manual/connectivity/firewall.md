...
<figure><img src="../../.gitbook/assets/new1 (5).png" alt=""><figcaption><p>Section "Network and Firewall" -> "Firewall" in MikoPBX</p></figcaption></figure>
...
* An external CrowdSec-compatible bouncer in front of the MikoPBX API — see [External firewall for Docker](../../security/external-firewall-enforcement.md).
