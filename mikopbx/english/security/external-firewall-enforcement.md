...
The full response format, query parameters, and MikoPBX↔CrowdSec field mapping are documented in [the firewall-export endpoint reference](../manual/system/api-keys/firewall-export.md).
