...
* **Docker deployment**: in bridge mode the built-in firewall and fail2ban do not protect the web interface. Set up an [external firewall bouncer](external-firewall-enforcement.md) or switch the container to `network_mode: host`.
