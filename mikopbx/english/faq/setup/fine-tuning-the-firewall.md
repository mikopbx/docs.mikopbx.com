...
{% hint style="warning" %}
This page applies to bare-metal and LXC installations. For Docker deployments see [External firewall for Docker](../../security/external-firewall-enforcement.md).
{% endhint %}
