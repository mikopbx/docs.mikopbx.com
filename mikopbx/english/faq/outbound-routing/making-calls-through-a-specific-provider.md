...
<figure><img src="../../.gitbook/assets/newRule (3).png" alt=""><figcaption><p>Creating a new rule</p></figcaption></figure>
...
1. Add **outbound rules** for the first and second Zadarma providers, as described in the [first method](making-calls-through-a-specific-provider.md#first_method). The settings are identical.
