...
# Обеспечение безопасности MikoPBX (in dev)
...
1. <mark style="color:$danger;">Обновиться до версии</mark> <mark style="color:$danger;"></mark><mark style="color:$danger;">**2024.1.114**</mark> <mark style="color:$danger;"></mark><mark style="color:$danger;">или новее.</mark>
2. Установить патч безопасности (см. ниже).
3. Закрыть WEB, CTI и SIP-доступ к станции извне.
...
Подробные инструкции: [docs.mikopbx.com — Патч 2024.1.114](https://docs.mikopbx.com)
...
Подробная инструкция: Сетевой экран — документация MikoPBX
...
Перейдите в раздел **«Сеть и Firewall» → «Защита от взлома»** и проверьте настройки:
