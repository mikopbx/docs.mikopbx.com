...
В новой версии в настройки сетевого интерфейса добавлены отдельные параметры для внешних SIP и SIP_TLS портов, с которых осуществляется проброс портов на сетевом маршрутизаторе.\
